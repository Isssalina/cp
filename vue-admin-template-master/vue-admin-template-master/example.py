...
blender_1 = XGBClassifier(nthread=-1, learning_rate=0.05, n_estimators=200, max_depth=1, subsample=0.3,
                          colsample_bytree=0.9, min_child_weight=1, silent=1, objective='binary:logistic')
